...
<html>
<head>
    <title>Sistem Informasi Akademik::Tambah Data KRS</title>
	<meta charset="utf-8">
...
<body onload="kode_klp()">
	...
	<div class="utama">			
		<br><br>
		<h3>TAMBAH DATA PENAWARAN MATA KULIAH</h3>
		<br>
		...
		<form id="faddTawar">			
			...
			<div class="form-group">
				...
				<select class="form-control" name="ruang" id="ruang">
					<?php
					$ruang=array('H.5.1','H.3.2','H.5.3','H.4.4','H.6.5','H.3.1','H.4.2','H.5.3','H.6.4','H.3.5');
			...
			<div class="form-group">
				...
				<select class="form-control" name="kapasitas" id="kapasitas">
					<?php
					$kapasitas=array('10','20','30','40','50');
	...
	$(document).ready(function(){
		$("#btnSimpan").on('click', function(){
			...
			$.ajax({
				type	: "post",
				url 	: "05930-nugroho-Tawarsv_add.php",
				data 	: {
					idmatkul: idmatkul,
					npp 	: npp,
					klp 	: klp,
