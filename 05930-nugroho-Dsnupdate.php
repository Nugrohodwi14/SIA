...
?>
    <div class="utama">
        ...
        <div class="text-center"><a href="05930-nugroho-Dsnpdfprn.php"><span class="fas fa-print">&nbsp;Print</span></a>
        </div>
        <span class="float-left">
            <a class="btn btn-success" href="05930-nugroho-Dsnadd.php">Tambah Data</a>
        </span>
        <span class="float-right">
            <form action="" method="post" class="form-inline">
                <button class="btn btn-success" type="submit">Cari</button>
                <input class="form-control mr-2 ml-2" type="text" name="cari" placeholder="cari data dosen..." autofocus
                    autocomplete="off">
            </form>
        </span>
        <br><br>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-outline-primary btn-sm"
                            href="05930-nugroho-Dsnedit.php?kode=<?php echo $row['id']?>">Edit</a>
                        <a class="btn btn-outline-danger btn-sm"
                            href="05930-nugroho-Dsnhps.php?kode=<?php echo $row["id"]?>" id="linkHps"
