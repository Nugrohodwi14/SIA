...
<body>
	...
	<div class="utama">
		...
		<div class="col-sm-3 text-center">
			...
			<div>
				[ <a href="05930-nugroho-MhsgantiFoto.php?id=<?php echo $row['id']?>">Ganti Foto</a> ]
			</div>	
		</div>
		<div class="col-sm-9">
			<form enctype="multipart/form-data" method="post" action="05930-nugroho-Mhssv_edit.php">
				...
				<div class="form-group">
					...
					<input class="form-control" type="date" name="tanggallahir" id="tanggallahir" value="<?php echo $row['tanggallahir']?>">
				</div>				
				<div>		
	...
	<script>
		$('#submit').on('click',function(){
			...
			$.ajax({
				method	: "POST",
				url		: "05930-nugroho-Mhssv_edit.php",
				data	: {id:id, nama:nama, email:email, tanggallahir:tanggallahir}
			});
		});
	</script>
</body>
