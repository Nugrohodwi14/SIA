...
<head>
	...
	<script>
		function cetak(hal) {
		  ...
		  xhttp.open("GET", "05930-nugroho-MatkulajaxUpdate.php?hal="+hal, true);
		  xhttp.send();
		}
	</script>		
</head>
...
<div class="utama">
	...
	<div class="text-center"><a href="05930-nugroho-MatkulPdfprn.php"><span class="fas fa-print">&nbsp;Print</span></a></div>
	<span class="float-left">
		<a class="btn btn-success" href="05930-nugroho-Matkuladd.php">Tambah Data</a>
	</span>
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
				<a class="btn btn-outline-primary btn-sm" href="05930-nugroho-Matkuledit.php?kode=<?php echo $row['idmatkul']?>">Edit</a>
				<a class="btn btn-outline-danger btn-sm" href="05930-nugroho-Matkulhps.php?kode=<?php echo $row["idmatkul"]?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
